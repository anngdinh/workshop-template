...
## 1.3 · Firecracker — `kata-fc` {background-color="#f5f2ec" .smaller}
...
## 1.4 · Cloud Hypervisor — `kata-clh` {background-color="#f5f2ec" .smaller}
...
## 1.5 · QEMU — `kata-qemu` {background-color="#f5f2ec" .smaller}
...
## 1.6 · gVisor — `runsc` {background-color="#f5f2ec" .smaller}
...
## 1.7 · How we measured {background-color="#f5f2ec" .smaller}
...
## 1.8 · ★ Headline results {background-color="#f5f2ec" .smaller .scrollable}
...
## 1.9 · Where do the seconds go? {background-color="#f5f2ec" .smaller}
...
## 1.10 · Runtime performance under load {background-color="#f5f2ec" .smaller .scrollable}
...
## 1.11 · The ops reality {background-color="#f5f2ec" .smaller}
...
## 1.12 · Capacity & cost {background-color="#f5f2ec" .smaller}
...
## 1.13 · Verdict {background-color="#f5f2ec" .smaller}
...
## 1.14 · Full routing table {background-color="#f5f2ec" .smaller .scrollable}
...
## 1.15 · Compatibility matrix {background-color="#f5f2ec" .smaller .scrollable}
